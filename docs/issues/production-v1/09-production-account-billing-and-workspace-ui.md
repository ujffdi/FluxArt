...
- [ ] Account pages show real session-backed identity, credit balance, and account-tier details.
- [ ] Billing pages show real credit pack purchase states.
...
- [ ] Download actions enforce HD, watermark, and credit rules.
